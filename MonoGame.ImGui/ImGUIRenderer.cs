...
namespace MonoGame.ImGui
{
	...
	public class ImGUIRenderer
	{
		...
		{
			_ = _texture_data.Loaded.Remove(textureId);
		}
		...
		public ImGUIRenderer Initialize()
		{
			...
			_ = _input_data.Initialize(Owner);
			return this;
		}
		...
		private static Rectangle GenerateScissorRect(ImDrawCmdPtr draw_command)
			=> new(
		...
		{
#pragma warning disable CS0618, CS0618
